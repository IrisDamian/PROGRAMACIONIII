 ...
 */
public class Grafo {
    char[]  nodos;  // Indicamos las letras de identificación de nodo
    int[][] grafo;  // Indicamos la matriz de distancias entre nodos
    ...
    public String encontrarRutaMinimaDijkstra(char inicio, char fin) {
        ...
        while(!pila.isEmpty()) ruta+=" "+(muni.MunicipiosJutiapa(pila.pop().id));
